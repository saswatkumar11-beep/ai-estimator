...
# -------------------------------
# Estimation Logic (Enhanced + Multipliers)
# -------------------------------
...
def estimate_effort(config_files, macros, complexity, criticality):
    ...
    # -------------------------------
    # Multipliers (Complexity + Criticality)
    # -------------------------------
    ...
    # -------------------------------
    # Analysis (MSP + CDS + DCR + Walkthrough)
    # -------------------------------
    ...
    # -------------------------------
    # Apply Phase Multipliers (NEW)
    # -------------------------------
    analysis *= 10
    customer_req = analysis * 2  # derived from analysis
